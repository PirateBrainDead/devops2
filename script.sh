...
echo PirateBraindead >> README.md
echo "[devops-lab-2-task](https://github.com/PirateBrainDead/devops2.git)" >> README.md
echo --- >> README.md
...
git remote add origin https://github.com/PirateBrainDead/devops2.git
git branch -M main
